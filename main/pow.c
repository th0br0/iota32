...
void seri(uint64_t *l, uint64_t *h, int n, trit_t* r)
{
  int i = 0;
...
int64_t  loop_cpu(uint64_t *lmid, uint64_t *hmid, int m, trit_t* nonce)
{
  int n = 0;
  int64_t i = 0;
...
// 01:-1 11:0 10:1
void para(trit_t* in, uint64_t* l, uint64_t* h)
{
  int i = 0;
...
int64_t pwork(trit_t* mid, int mwm, trit_t* nonce,int n)
{
